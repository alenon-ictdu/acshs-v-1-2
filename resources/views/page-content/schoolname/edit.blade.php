...
@section('header')
    <section class="content-header">
      <h1>
        Schoolnames<small>Edit schoolname.</small>
      </h1>
      <ol class="breadcrumb">
...
<div class="row">
  <div class="col-md-8 col-md-offset-2">
    ...
    @endif
      ...
      <form method="post" action="{{ route('schoolname.update', $schoolname->id) }}" enctype="multipart/form-data">
      ...
      <div class="box">
        ...
        <div class="box-body row display-flex-wrap" style="display: flex; flex-wrap: wrap;">
          ...
          <div class="form-group col-xs-12">
            <label>Name</label>
            <input type="text" name="name" class="form-control" value="{{ $schoolname->name }}">
          </div>

          <div class="form-group col-xs-12">
            <label>Abbreviation</label>
            <input type="text" class="form-control" name="abbreviation" value="{{ $schoolname->abbreviation }}">
          </div>
