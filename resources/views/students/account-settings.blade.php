                    ...
                    <div class="panel-group" id="accordion">
                          ...
                          <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-1">
                                        ...
                                        @else
                                            <img src="{{ asset('uploads/student/' . Auth::user()->image) }}" width="100" height="100">
                                        @endif
                                    </div>
                                    <div class="col-md-8">                          
                                        <form action="{{ route('student.update.picture') }}" method="POST" enctype="multipart/form-data" data-parsley-validate="parsley">
                                            {{ csrf_field() }}
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"  placeholder="Name" value="{{ Auth::user()->s_id }}" name="name" required data-parsley-required-message="Name is required" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"  placeholder="Name" value="{{ Auth::user()->birthday }}" name="name" required data-parsley-required-message="Name is required" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"  placeholder="Name" value="{{ Auth::user()->contact }}" name="name" required data-parsley-required-message="Name is required" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="exampleInputName">Religion</label>
                                            <input type="text" class="form-control"  placeholder="Name" value="{{ Auth::user()->religion }}" name="name" required data-parsley-required-message="Name is required" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="exampleInputName">Address1</label>
                                            <input type="text" class="form-control"  placeholder="Name" value="{{ Auth::user()->address1 }}" name="name" required data-parsley-required-message="Name is required" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"  placeholder="Name" value="{{ Auth::user()->address2 }}" name="name" required data-parsley-required-message="Name is required" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="exampleInputName">Barangay</label>
                                            <input type="text" class="form-control"  placeholder="Name" value="{{ Auth::user()->barangay }}" name="name" required data-parsley-required-message="Name is required" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="exampleInputName">Municipality</label>
                                            <input type="text" class="form-control"  placeholder="Name" value="{{ Auth::user()->municipality }}" name="name" required data-parsley-required-message="Name is required" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"  placeholder="Name" value="{{ Auth::user()->province }}" name="name" required data-parsley-required-message="Name is required" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="exampleInputName">Father</label>
                                            <input type="text" class="form-control"  placeholder="Name" value="{{ Auth::user()->father }}" name="name" required data-parsley-required-message="Name is required" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="exampleInputName">Mother</label>
                                            <input type="text" class="form-control"  placeholder="Name" value="{{ Auth::user()->mother }}" name="name" required data-parsley-required-message="Name is required" disabled>
                                        </div>
                                    </div>
                                </div>
                                
                                <form action="{{ route('student.update.info') }}" method="POST" data-parsley-validate="parsley">
                                  {{ csrf_field() }}
                                  <div class="form-group">
                                    <label for="exampleInputEmail">Email address</label>
                                    <input type="email" class="form-control" id="exampleInputEmail" placeholder="Email" value="{{ Auth::user()->email }}" name="email" required>
                                  </div>
                                  <button class="btn btn-success btn-sm"><i class="fa fa-save"></i> Save</button>
                                </form>
                          </div>
                      ...
                      <div class="panel panel-default">
                        ...
                        <div id="collapse3" class="panel-collapse collapse @if($errors->has('old_password') || $errors->has('new_password')) in @endif @if(session('password-is-in')) in @endif">
                          <div class="panel-body">
                                <form action="{{ route('student.update.password', Auth::user()->id) }}" method="POST" data-parsley-validate="parsley">
                                  <div class="form-group">
