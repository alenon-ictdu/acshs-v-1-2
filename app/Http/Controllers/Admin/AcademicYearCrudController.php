...
class AcademicYearCrudController extends CrudController
{
    ...
    {
        //storing all the years starting 1900 to current year in the yearArr
        $yearsArr = [];
        ...
        */
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/academicyear');
        $this->crud->setEntityNameStrings('academicyear', 'academic_years');
